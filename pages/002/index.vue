...
<div class="w-full bg-slate-200 px-4 py-2">
	<div class="barPanel h-12 rounded-3xl ml-4 mb-2 px-1">
		<div class="top-icon filter ml-4 -mt-1" @click="toggleFilter()">
			<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="-50 -50 550 550" style="enable-background:new 0  0 487.95 487.95;" xml:space="preserve" width="30px" height="30px">
